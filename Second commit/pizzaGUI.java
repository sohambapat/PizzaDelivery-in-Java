...
public class pizzaGUI extends JFrame {
    ...
    private JRadioButton check_beverage_cola;
    private JRadioButton check_beverage_tea;
    private JRadioButton check_beverage_lemonade;
    private JRadioButton check_beverage_water;
    private JRadioButton check_beverage_coffee;
    private JRadioButton check_bevsize_small;
    private JRadioButton check_bevsize_medium;
    private JRadioButton check_bevsize_large;
    ...
    private JPanel jp_beverageType;
    private JButton checkoutButton;
    private ButtonGroup bg1, bg2, bg3, bg4, bg5;
...
//Create frame
    public pizzaGUI() {
        ...
        jp_beverageType = new JPanel();
        jp_beverageType.setBounds(450, 50, 240, 210);
        panel_main.add(jp_beverageType);
        jp_beverageType.setLayout(null);
        
        JLabel label_18 = new JLabel("Choose a Beverage");
        label_18.setFont(new Font("Cambria", Font.BOLD, 13));
        label_18.setBounds(6, 10, 120, 21);
        jp_beverageType.add(label_18);
        
        check_beverage_cola = new JRadioButton("Cola - $1.00");
        check_beverage_cola.setFont(new Font("Cambria", Font.ITALIC, 11));
        check_beverage_cola.setBounds(6, 30, 120, 20);
        jp_beverageType.add(check_beverage_cola);
        
        check_beverage_tea = new JRadioButton("Tea - $1.10");
        check_beverage_tea.setFont(new Font("Cambria", Font.ITALIC, 11));
        check_beverage_tea.setBounds(6, 50, 120, 20);
        jp_beverageType.add(check_beverage_tea);
        
        check_beverage_lemonade = new JRadioButton("Lemonade - $1.59");
        check_beverage_lemonade.setFont(new Font("Cambria", Font.ITALIC, 11));
        check_beverage_lemonade.setBounds(6, 70, 120, 20);
        jp_beverageType.add(check_beverage_lemonade);
        
        check_beverage_water = new JRadioButton("Water - $1.00");
        check_beverage_water.setFont(new Font("Cambria", Font.ITALIC, 11));
        check_beverage_water.setBounds(6, 90, 120, 20);
        jp_beverageType.add(check_beverage_water);
        
        check_beverage_coffee = new JRadioButton("Coffee - $1.39");
        check_beverage_coffee.setFont(new Font("Cambria", Font.ITALIC, 11));
        check_beverage_coffee.setBounds(6,110, 120, 20);
        jp_beverageType.add(check_beverage_coffee);
        
        check_bevsize_small = new JRadioButton("Small - no charge");
        check_bevsize_small.setFont(new Font("Cambria", Font.ITALIC, 11));
        check_bevsize_small.setBounds(6, 140, 120, 20);
        jp_beverageType.add(check_bevsize_small);
        
        check_bevsize_medium = new JRadioButton("Medium - $0.20");
        check_bevsize_medium.setFont(new Font("Cambria", Font.ITALIC, 11));
        check_bevsize_medium.setBounds(6, 160, 120, 20);
        jp_beverageType.add(check_bevsize_medium);
        
        check_bevsize_large = new JRadioButton("Large - $0.40");
        check_bevsize_large.setFont(new Font("Cambria", Font.ITALIC, 11));
        check_bevsize_large.setBounds(6, 180, 120, 20);
        jp_beverageType.add(check_bevsize_large);
...
// action listener of check out button
    ...
    private void addRadioButtonGroups()
    {
        ...
        bg4 = new ButtonGroup();
        bg4.add(check_beverage_cola);
        bg4.add(check_beverage_tea);
        bg4.add(check_beverage_lemonade);
        bg4.add(check_beverage_coffee);
        bg4.add(check_beverage_water);
        
        bg5 = new ButtonGroup();
        bg5.add(check_bevsize_small);
        bg5.add(check_bevsize_medium);
        bg5.add(check_bevsize_large);
    ...
    private void reset()
    {
        ...
        check_beverage_cola.setSelected(true);
        check_bevsize_small.setSelected(true);
    }
    ...
    public void showBill(String name, String addr, String phone) {
        ...
        double toppings = 0;
        double crust = 0;
        double beverageType = 0;
        double beverageSize = 0;
        double subtotal = 0;
        double total = 0;
        double tax = 0;
        double deliverFee = 0;
        ...
        if(check_beverage_cola.isSelected()){
            beverageType = 1.00;
        }
        
        else if(check_beverage_tea.isSelected()){
            beverageType = 1.10;
        }
        
        else if(check_beverage_lemonade.isSelected()){
            beverageType = 1.59;
        }
        
        else if(check_beverage_coffee.isSelected()){
            beverageType = 1.39;
        }
        ...
        if(check_bevsize_small.isSelected()){
            beverageSize = 0;
        }
        
        else if(check_bevsize_medium.isSelected()){
            beverageSize = 0.2;
        }
        ...
        subtotal = pizzaSizeCost + crust + toppings + beverageType + beverageSize;
        ...
        bill_tax.setText(String.format("$"+df.format(tax)));
        bill_total.setText(String.format("$"+df.format(total)));
        ...
        jp_beverageType.setVisible(false);
